...
class CompilerContainer {
  ...
  constructor (compileTabLogic, editor, config, queryParams) {
    ...
    this.data = {
      ...
      defaultVersion: 'soljson-v0.6.10+commit.00c0fcaf.js', // this default version is defined: in makeMockCompiler (for browser test) and in package.json (downloadsolc_root) for the builtin compiler
